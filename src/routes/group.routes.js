    ...
    try{
        ...
        .on("end", function () {
            ...
            function myFunction(item) {
                ...
                const propertyNames = 'name,number_of_seats,maximum_minutes,logical_number,user_id,org_id';
...
// Retrieve group of user with id
router.get('/users/:id', groupController.findByGroupId);
